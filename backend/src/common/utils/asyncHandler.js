const asyncHandler = (requestHandler) => {
  //requestHandler is expected to be any function that handles a request and is expected to perform asynchronous operations
  return (req, res, next) => {
    // Purpose of this middleware is to catch any errors that occur in the requestHandler
